...
<div className="flex flex-col px-12 pt-16 pb-8 gap-6">
      ...
      <div className="max-w-5xl w-full">
        ...
        <div className="relative w-full rounded-2xl overflow-hidden" style={{ height: "600px" }}>
          <Image src={project.img} alt={project.name} fill className="object-cover object-top" />
