...
export default function AboutSummary() {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-[#010101] overflow-hidden py-32">
      ...
      <div className="container max-w-6xl px-8 mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {infoItems.map((item, i) => (
                <motion.div
                  ...
                  className="group p-6 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300"
                >
                  <div className="p-2.5 w-fit rounded-xl bg-white/[0.03] border border-white/5 mb-4 group-hover:scale-110 transition-transform duration-300 text-white/60">
                    {item.icon}
                  </div>
            ...
            <motion.div
              ...
              className="mt-8 p-8 rounded-[2.5rem] bg-gradient-to-br from-white/[0.03] to-transparent border border-white/[0.03]"
            >
